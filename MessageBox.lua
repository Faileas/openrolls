function OpenRolls:CreateMessageBox(text, yes, no)
    ...
    local cancel = CreateFrame("Button", "OpenRollsMessageBoxCancel" .. count, box,"UIPanelButtonTemplate")
    ...
    local confirm = CreateFrame("Button", "OpenRollsMessageBoxConfirm" .. count, box,"UIPanelButtonTemplate")
    ...
    local str = box:CreateFontString("OpenRollsMessageBoxString" .. count, "OVERLAY", "GameFontNormal")
